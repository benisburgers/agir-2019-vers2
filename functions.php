...
function setupRing($value1, $value2 = null, $color = null, $term = null) {
	$percentage1 = $value1;
	$percentage2 = $value2;
	$ringColor = $color;
	$chartTerm = $term;
	...
	if ($term != null) {
		$chartTerm = '<div class="term"><p>' . $term . '</p></div>';
	}

	if (!$percentage2 == null) {
		echo '
		<div class="radial-progress nested scandal-mint" data-progress-1="' . $percentage1 . '">
			<div class="circle">
				<div class="mask full">
					<div class="fill"></div>
				</div>
			...
			<div class="inset">
				...
				<div class="radial-progress carmine-pink" data-progress-2="' . $percentage2 . '">
					<div class="circle">
						<div class="mask full">
							<div class="fill"></div>
						</div>
		...
		echo '
			<div class="radial-progress ' . $ringColor . '" data-progress="' . $percentage1 .'">
				<div class="circle">
					<div class="mask full">
						<div class="fill"></div>
					</div>
